...
$yoursubject = mysqli_real_escape_string($link, $_REQUEST['yoursubject']);
$yourmessage = mysqli_real_escape_string($link, $_REQUEST['yourmessage']);
// Attempt insert query execution
$sql = "INSERT INTO contact_us (fullname, email, yoursubject, yourmessage) VALUES ('$fullname', '$email','$yoursubject','$yourmessage')";
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                <li>
                                    <i class="fab fa-opencart"></i> Simba Supermarket is offering 20% off on
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> 50% - 80% off on Vegetables in Sawa City
                                </li>
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <div>
                        <b><h3 style="color: green;"></b>
                        Recorded succesfully
                        </h3>
                        </div>
                        <form id="contact_us" action="contact.php" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Your Name" required data-error="Please enter your name">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Your Email" id="email" name="email" class="form-control"  required data-error="Please enter your email">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="yoursubject" name="yoursubject" placeholder="Subject" required data-error="Please enter your Subject">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="yourmessage" name="yourmessage" placeholder="Your Message" rows="4" data-error="Write your message" required></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
				...
				<div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>CONTACT INFO</h2>
                     <p>Please email us your questions regarding our products.
                        Welcome to shoproute. Please fill in your details below and we will use the information provided for customer service purposes. Please note that shoproute values and respects your privacy and will only use your data for services purposes and will not share it with third parties. Please read the shoproute Privacy Statement for more information.  </p>
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>KN7 Remera</p>
                            </li>
                            <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><i class="fas fa-envelope"></i>Email: <a
                                            href="mailto:shoproute@gmail.com">ShopRoute@gmail.com</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
